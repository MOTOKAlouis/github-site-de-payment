...
if(isset($_POST['Submit'])){
  ...
  if(in_array($_FILES["file"]["type"],$mimes)){
    ...
    $uploadFilePath = 'uploads_lome/'.basename($_FILES['file']['name']);
    ...
    for($i=0;$i<$totalSheet;$i++){
     ...
     // echo "<br>code : $code -- pass: $passwd <br>";
        ...
        $query = "INSERT INTO ticket (code,passwd,statut,montant,date_creation,heure_creation)
    ...
    $query = "DELETE FROM ticket WHERE code=?";
    $query_run = $conn->prepare($query);
