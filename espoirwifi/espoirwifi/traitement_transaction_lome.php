...
$token= "ba68bf6c-e04f-4573-ab23-396ba93f7b67";
...
$data_result = json_decode($response);
    ...
    $query = "INSERT INTO transaction (numero,id_paygate,statut,identifiant,etat,montant,reseau,date_creation,heure_creation)
