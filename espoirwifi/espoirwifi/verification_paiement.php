...
<?php
  ...
  //verification si l'identifiant n'a pas encore été utiliser
    ...
    $query = "SELECT * FROM ticket_kara WHERE identifier=:identifiant ";
...
//verification du paiement par le code de reference
          ...
          $curl = curl_init();
          $data = array ( "auth_token" => "f3f80615-e787-4636-8d3d-25cde60d57a9", "identifier" => $identifiant);
            ...
            if ($etat==0){
              ...
              if (!isset($conn)){
                require 'connexion.php';
                  ...
                  $sql = 'SELECT * 
                  FROM ticket_kara WHERE statut = 0 AND montant ='.$montant_transaction.' limit 0,1';
       ...
       $sql = "UPDATE ticket_kara SET statut=:statut, date_achat_code=:date_achat, heure_achat_code=:heure_achat, identifier=:identifier WHERE id=:id";
