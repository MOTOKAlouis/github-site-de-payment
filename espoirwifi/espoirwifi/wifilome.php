...
<div class="alert alert-primary d-flex align-items-center" role="alert">
  ...
  <label for="numero" class="form-label">Numéro de Téléphone </label>
	  <input required  class="form-control" type ="number" name="phone_number" placeholder="Votre numéro T-money">
	  </div>
	  <div class="mb-3">
	  ...
	  <select class="form-select" name="amount" aria-label="Default select example">
	        ...
	        <option value="50">50F (2 heures)</option>
	         <option value="100">100F (5 heures)</option>
	             <option value="200">200F (48 heures)</option>  
				    <option value="500">500F(7 Jours)</option>
	                     <option value="1500">1500F(Un mois)</option>
	                        <option value="3000">3000F (1 mois -3 utils)</option>
	                       
	    </select>
	    
	 </div>
	 <div class="mb-3">
	      <label for="Reseau" class="form-label">Type de Reseau</label> 
	...
	<?       if(isset($_POST['paiement'])) {
      ...
      include ("traitement_transaction_lome.php");
...
-->
 ...
 if(isset($_POST['valider'])) {
      ...
      require 'verification_paiement_lome.php';
