...
<?php
include ('header_bienfaiteur.php');
include ('alertTicket_bienfaiteur.php');
?>
...
<div class="container">
	...
	<!-- <br>  -->
        <div align="center">
            <marquee>
            	SVP <b>POUR LES</b> LES ACHATS PAR <b style='color:red'>FLOOZ</b>, TAPEZ <b style='color:red'><i>* 155 * 27 #</i></b> POUR VALIDER L'OPERATION.
            </marquee>
        </div>
    <br>
...
<div class="alert alert-primary d-flex align-items-center" role="alert">
  ...
  <div>
  RECUPEREZ VOTRE TICKET WIFI MANUELLEMENT
  </div>
</div>
  ...
  <input type="number" name="tx_reference" class="form-control" id="tx_reference" placeholder="NE METTEZ RIEN ICI SVP...">
</div>
 ...
 if(isset($_POST['valider'])) {
      ...
      require 'verification_paiement_bienfaiteur.php';
...
?>
 ...
 <div>
    ...
    <br>
              <div class="alert alert-primary d-flex align-items-center" role="alert">
                  <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Info:"><use xlink:href="#info-fill"/></svg>
              COMMENT ACHETER UN TICKET PAR T-MONEY 
               </div> 
                  <video controls class="embed-responsive-item" width="100%" height="50%" align="center" allowfullscreen>
...
<div class="alert alert-primary d-flex align-items-center" role="alert">
  ...
  <label for="numero" class="form-label">Numéro de Téléphone </label>
	  <input required  class="form-control" type ="number" name="phone_number" placeholder="Votre numéro Mobile money">
	  </div>
	  <div class="mb-3">
	   <label for="montant" class="form-label">Montant </label> 
	  <select class="form-select" name="amount" aria-label="Default select example">
            
        <!-- <option value="1">50F (2heures)</option> -->
	        <option value="100">100F (3 heures)</option> 
	            <option value="200">200F (24 heures)</option> 
			        <option value="500">500F (3 jours)</option>
	                    <option value="1000">1000F (7 jours)</option>
	      </select>
	 </div>
	 <div class="mb-3">
	  ...
	  <select class="form-select" name="network" aria-label="Default select example">  
		    ...
		    <option value="FLOOZ">FLOOZ(A partir de 200fcfa)</option>
	...
	<?       if(isset($_POST['paiement'])) {
      ...
      include ("traitement_transaction_bienfaiteur.php");
...
<?php  echo "<br><br>";
 include 'footer_bienfaiteur.php';
 echo "<br><br>"; ?>
